...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activer pour trier la colonne en croissant",sSortDescending:": activer pour trier la colonne décroissante"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée disponible",sInfo:"Affichage de _START_ à _END_ sur _TOTAL_ entrées",
sInfoEmpty:"Afficher 0 à 0 de 0 entrées",sInfoFiltered:"(filtré à partir de _MAX_ entrées au total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Montrer _MENU_ entrées",sLoadingRecords:"Chargement...",sProcessing:"En traitement...",sSearch:"Chercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
